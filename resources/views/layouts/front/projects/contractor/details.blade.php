									...
									<div class="project-detail-tabs">
										<nav>
											<div class="nav nav-tabs" id="nav-tab" role="tablist">
												<button class="nav-link active" id="nav-design-studio-tab" data-bs-toggle="tab" data-bs-target="#nav-design-studio" type="button" role="tab" aria-controls="nav-design-studio" aria-selected="true">Design studio</button>
												<button class="nav-link" id="nav-general-info-tab" data-bs-toggle="tab" data-bs-target="#nav-general-info" type="button" role="tab" aria-controls="nav-general-info" aria-selected="false">General Info</button>
										...
										<div class="tab-content" id="project-detail-nav">
											<div class="tab-pane fade show active" id="nav-design-studio" role="tabpanel" aria-labelledby="nav-design-studio-tab" tabindex="0">
												<div class="row">
													<div class="col-12">
														<div class="section-subtitle">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row justify-content-center">
													<div class="col-12 col-md-6 col-lg-4">
														<a class="btn-primary d-block" href="javascript:void(0)">Next</a>
													</div>
												</div>
											</div>
