				...
				<div class="col-12 col-lg-6 d-flex login-form-wrap align-items-lg-center min-height-100vh">
					<div class="login-wrap">
						...
						@endif
							...
							<!-- START SELECT USER -->
							<section class="stepform-sec p-0">
								<div class="container">
									<div class="row">
																...
																<div class="form-label type-of-customer-item">
																	<label for="customer">
																		...
																		<div class="customer-type-wrap d-flex align-items-center justify-content-between">
																			...
																			<input id="customer" type="radio" checked="checked" value="customer" name="role">
																		</div>
																	</label>
																</div>
															</div>
																...
																<div class="form-label type-of-customer-item">
																	<label for="contractor">
																		...
																		<div class="customer-type-wrap d-flex align-items-center justify-content-between">
																			...
																			<input id="contractor" value="contractor" type="radio" name="role">
																		</div>
																	</label>
																</div>
															</div>
																	...
																	<div class="upload-img-wrap">
																		...
																		<label for="uploadimage">
																			<div class="upload-img-icon">
																				<img src="https://glorywebsdemo.com/Laravel/wroofing_laravel/public/frontend-assets/images/img-icon.svg" alt="img-icon" width="30" height="30">
																			</div>
