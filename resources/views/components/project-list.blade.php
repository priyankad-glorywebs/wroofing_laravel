...
<div class="project-list-sec">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="project-list-item">
                    ...
                    {{--<a class="project-list-item-link" href="project-detail.html"></a>--}}
                     <a class="project-list-item-link" href="{{URL::to('add/project/'.base64_encode($project->id))}}">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="project-list-item">
                    ...
                    <a class="project-list-item-link project-link-trigger"  href="javascript:void(0);" id="addnewprojectlink"></a>
        ...
        <div class="row d-lg-none">
            <div class="col-12">
                <a class="btn-primary d-block" href="project-detail.html">Add a new project</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Quote Modal -->
{{-- <div class="modal fade addproject quotepopup" id="addproject" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="quotepopup-wrap">
                    ...
                    <div class="quotepopup-button-wrap d-flex">
                        <a class="btn-primary d-block" id="approvebtn" href="javascript:void(0);">Add Project</a>
                    </div>
                </div>
            </div>
            </form>
...
<div class="modal fade addprojectpopup quotepopup" id="addprojectpopup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title" id="staticBackdropLabel">Add Project</div>
            ...
            <form name="addProjectform" method="post">
                <div class="modal-body">
                    <div class="quotepopup-wrap">
                        ...
                        <div class="form-element">
                            <input type="text" name="projectname" id="projectname" placeholder="Enter your Project Name">
                        </div>
